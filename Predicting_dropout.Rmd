...
author: 
  Group assignment
  My contribution is dataset selection; implementation of Model 4 in Sections 2 to 5; 
  and Section 6: Interpretation of parameters
date: "`r Sys.Date()`"
output:
  html_document:
    theme: readable
...
debts is associated with the overall dropout, is this effect valid and consistent across all groups? 
...
Tuition.fees.up.to.date, Course and Curricular.units.1st.sem..approved. as shown in plots 4, 5 and 6 below.
